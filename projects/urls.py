...
urlpatterns = [
    ...
    path('project-detail/<int:project_id>/', ProjectDetailAndPermissionsView.as_view(), name='project-detail'),
    ...
    path('document-watchlist/', ProjectWatchlistView.as_view(), name='document_add_watchlist'),
